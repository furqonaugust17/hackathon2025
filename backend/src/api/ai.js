...
- ATURAN:
  ...
  2. Dosen yang diam diisi array string kosong: [""]
  3. Mahasiswa WAJIB merespons.
  4. Semua dialog SANGAT RINGKAS (maks 15 kata).
  5. Gunakan narasi singkat (cth: (tersenyum miring)).
